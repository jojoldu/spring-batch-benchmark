 ...
 * {@link EntityManagerFactory}. All entity access is
 ...
 * @since 2.0
 */
public class FixedJpaPagingItemReader<T> extends AbstractPagingItemReader<T> {
	...
	public FixedJpaPagingItemReader() {
		setName(ClassUtils.getShortName(FixedJpaPagingItemReader.class));
	}
